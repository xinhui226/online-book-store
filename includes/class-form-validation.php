            ...
            switch($condition)
            {
               case 'required' :
                ...
                case 'text' :
                    ...
                    elseif (!preg_match("/^[a-zA-Z ]*$/",$data[$key])) {  
                        $error .= 'Only alphabets and white space are allowed for "'.$key.'"<br>';  
                    }
                    elseif(strlen($data[$key])<3)
                    {
                        $error.= 'Please enter at least 3 characters for "'.$key.'"<br>';
                    }
                    break;
                case 'numeric' :
                    if(empty($data[$key]))
                    ...
                    elseif (!is_numeric($data[$key])){  
                        $error .= 'Only numeric value is allowed for field "'.$key.'"<br>';  
                    }
                    break;
                case 'password_check' :
                    if(empty($data[$key]))
                ...
                case 'is_password_match' :
                    ...
                    {
                        $error.= 'Password and Confirm password is not match<br>';
                    }
                    break;
                case 'email_check' :
                    if(empty($data[$key]))
                ...
                case 'contact_form_token' :
                    if(!CSRF::verifyToken($data[$key],'contact_form'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'edit_author_token' :
                    if(!CSRF::verifyToken($data[$key],'edit_author'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'add_author_token' :
                    if(!CSRF::verifyToken($data[$key],'add_author'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'delete_author_token' :
                    if(!CSRF::verifyToken($data[$key],'delete_author'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'edit_category_token' :
                    if(!CSRF::verifyToken($data[$key],'edit_category'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'add_category_token' :
                    if(!CSRF::verifyToken($data[$key],'add_category'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'delete_category_token' :
                    if(!CSRF::verifyToken($data[$key],'delete_category'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'edit_message_token' :
                    if(!CSRF::verifyToken($data[$key],'edit_message'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'delete_message_token' :
                    if(!CSRF::verifyToken($data[$key],'delete_message'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'add_product_token' :
                    if(!CSRF::verifyToken($data[$key],'add_product'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'edit_product_token' :
                    if(!CSRF::verifyToken($data[$key],'edit_product'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'delete_product_token' :
                    if(!CSRF::verifyToken($data[$key],'delete_product'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'add_account_token' :
                    if(!CSRF::verifyToken($data[$key],'add_account'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'edit_account_token' :
                    if(!CSRF::verifyToken($data[$key],'edit_account'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'delete_account_token' :
                    if(!CSRF::verifyToken($data[$key],'delete_account'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'add_cart_token' :
                    if(!CSRF::verifyToken($data[$key],'add_cart_item'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'delete_cart_token' :
                    if(!CSRF::verifyToken($data[$key],'delete_cart_item'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'increase_cart_token' :
                    if(!CSRF::verifyToken($data[$key],'increase_cart_item'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'decrease_cart_token' :
                    if(!CSRF::verifyToken($data[$key],'decrease_cart_item'))
                    {
                        die ('Nice Try');
                    }
                    break;
                case 'checkout_form_token' :
                    if(!CSRF::verifyToken($data[$key],'checkout_form'))
                    {
                        die ('Nice Try');
                    }
                    break;
